...
% Note. For the workshop paper template, both \title{} and \workshoptitle{} are required, with the former indicating the paper title shown in the title and the latter indicating the workshop title displayed in the footnote. 
\title{Report for Project 5: Image Captioning}
...
\author{%
  Reza Naziri Asl\\
  \texttt{eXXXXXXXX@student.tuwien.ac.at} \\
  % examples of more authors
  \And
  Alireza Niroumand Sarvandani  \\
  \texttt{eXXXXXXXX@student.tuwien.ac.at} \\
  \And
  Emanuel Klatzer \\
...
\begin{abstract}
    <Here we should place an abstract; we can leave this until the end and get some inspiration on how other groups wrote theirs. But usually an abstract should tell what we did, which methods we used and what the results were.> 
\end{abstract}
