...
achieves a BLEU-1 of \textbf{0.543} and a BLEU-4 of \textbf{0.138} on a
...
\end{equation}
The backbone is \textbf{frozen}: $\approx$\textbf{2.2M trainable} vs $\approx$\textbf{23.5M frozen} parameters.
...
\begin{table}[h]
  ...
  \begin{tabular}{lcccc}
    ...
    \textbf{Ours} (frozen ResNet-50 + LSTM, greedy)
      & \textbf{0.543} & \textbf{0.351} & \textbf{0.221} & \textbf{0.138} \\
    \midrule
...
Freezing the backbone makes training fast and stable: only $\approx 8\%$ of
...
system on Flickr8k. The system achieves a BLEU-1 of \textbf{0.543} and a
BLEU-4 of \textbf{0.138}, producing fluent captions for common scenes while
